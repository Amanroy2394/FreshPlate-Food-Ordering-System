            ...
            <div class="card-body p-4">
              ...
              <% if (request.getParameter("db") != null) { %>
                <div class="alert alert-warning">
                  Cannot connect to database. Create <code>db.local.properties</code> next to <code>pom.xml</code>
                  (see <code>db.local.properties.example</code>), set <code>jdbc.password</code>, then restart server.
                </div>
              <% } %>
